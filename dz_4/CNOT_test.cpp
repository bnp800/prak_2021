...
void Qubit(complexd *op1, complexd *op2, complexd *op3, complexd *op4, complexd *out, complexd U[4][4], int nqubits, unsigned long size, int left, int q1, int q2)
{
...
int main(int argc, char *argv[])
{
    ...
    string name = "CNOT_res.txt"; //+ to_string(world_size) + ".txt";
    MPI_File fin, fout;
